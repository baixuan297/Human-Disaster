...
@onready var nakama_multiplayer_bridge: NakamaMultiplayerBridge: set = _set_readonly_variable_bridge
func _set_readonly_variable_bridge(_value):
	nakama_multiplayer_bridge = _value
	pass
# Nakama variables:
var nakama_socket: NakamaSocket: set = _set_readonly_variable_socket
func _set_readonly_variable_socket(_value) -> void:
	nakama_socket = _value
	pass
	
var match_id: String: get = get_match_id, set = _set_readonly_variable_id
func _set_readonly_variable_id(_value) -> void:
	match_id = _value
	pass

var matchmaker_ticket: String: set = _set_readonly_variable_ticket
func _set_readonly_variable_ticket(_value) -> void:
	matchmaker_ticket = _value
	pass

var players: Dictionary: set = _set_readonly_variable_players
func _set_readonly_variable_players(_value) -> void:
	players = _value
	pass
...
var match_state: int = MatchState.LOBBY: get = get_match_state, set = _set_readonly_variable_state
func _set_readonly_variable_state(_value) -> void:
	match_state = _value
	pass
...
var match_mode: int = MatchMode.NONE: get = get_match_mode, set = _set_readonly_variable_mode
func _set_readonly_variable_mode(_value) -> void:
	match_mode = _value
	pass
...
# func get_nakama_multiplayer_bridge():
...
func _set_nakama_socket(_nakama_socket: NakamaSocket) -> void:
	...
	if nakama_socket:
		...
		nakama_multiplayer_bridge.connect("match_joined", _on_match_joined)
...
func _ready() -> void:
	var tree = get_tree()
	tree.connect("network_peer_connected", _on_network_peer_connected)
	tree.connect("network_peer_disconnected", _on_network_peer_disconnected)
